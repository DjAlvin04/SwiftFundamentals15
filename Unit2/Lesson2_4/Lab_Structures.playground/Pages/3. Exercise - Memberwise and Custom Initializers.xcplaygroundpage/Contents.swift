...
var favoriteBook = Book(title: "\"Things Fall Apart\"", author: "Chinua Achebe", pages: 222, price: 10.99)
print("My favorite book is \(favoriteBook.title) by \(favoriteBook.author). It has \(favoriteBook.pages) pages and costs \(favoriteBook.price) dollars.")
...
var macBookPro14 = Laptop( screenSize: 14, yearPurchased: 2015)
var macBookPro15 = Laptop(screenSize: 15, yearPurchased: 2017 )
/*:
