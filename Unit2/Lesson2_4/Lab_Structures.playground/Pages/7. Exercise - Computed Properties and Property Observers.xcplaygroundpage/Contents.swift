...
struct Height {
    var heightInInches: Double {
        didSet {
            let ExpectedHeightInCm = heightInInches * 2.54
            if heightInCentimeters != ExpectedHeightInCm {
                heightInCentimeters = ExpectedHeightInCm
            }
        }
        }
    ...
    var heightInCentimeters: Double {
        didSet{
            let ExpectedHeightInInches = heightInCentimeters/2.54
            if heightInInches != ExpectedHeightInInches {
                heightInInches = ExpectedHeightInInches
            }
        }
    }
...
var myHeight = Height(heightInInches: 62)

// changing height in inches to cm
myHeight.heightInInches = 65
print(myHeight.heightInCentimeters)

//calling the other function to change cm to inches
myHeight.heightInCentimeters = 160
