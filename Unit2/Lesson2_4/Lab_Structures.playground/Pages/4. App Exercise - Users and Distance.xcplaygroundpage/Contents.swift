...
var Andy = User(name: "Andy Kromeh", age: 20, height: 5.9, weight: 250, activityLevel: 7)
print("My name is \(Andy.name) and I am \(Andy.age) years old. I weigh \(Andy.weight) pounds. My height is \(Andy.height) and my activity level is \(Andy.activityLevel).")
