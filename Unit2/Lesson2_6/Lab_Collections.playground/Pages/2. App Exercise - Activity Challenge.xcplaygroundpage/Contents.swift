 ...
 */
let walkingChallenges: [String] = ["Briskwalk 10 minutes daily", "Walk 10,000 steps daily for a week", "Hike to a scenic overlook"]

let runningChallenges: [String] = ["Run a 5k", "Run a 10k", "Complete a half marathon", "Run every day for a month"]


let yogaChallenges: [String] = ["Hold a plank for 2 minutes", "Master a headstand", "Practice yoga daily for a month"]
...
var challenges: [[String]] = [walkingChallenges, runningChallenges, yogaChallenges]
...
var committedChallenges: [String] = ["Run a 5k", "Briskwalk 10 minutes daily"]
