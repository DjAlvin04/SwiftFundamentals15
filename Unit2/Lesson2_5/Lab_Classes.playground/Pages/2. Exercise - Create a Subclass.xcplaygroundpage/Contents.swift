...
print("falcon is an instance of Spaceship class. It does not have a property named \"weapon\", and cannot inherit it from the Fighter class because a subclass(Fighter) inherits from the superclass(Spaceship), not the other way around. Therefore, this code does not compile")
