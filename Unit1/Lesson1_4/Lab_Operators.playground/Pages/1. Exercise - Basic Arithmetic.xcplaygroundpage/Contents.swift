...
print("The result of integer division is rounded down to the nearest whole number")
print("Meanwhile, the result of dividing both double type values is the decimal and its decimal places")
...
print("Using the remainder operator, I can determine if an integer is odd when the result of the operation is 1 or more")
print("If the result turns out to be 0, the integer is an even number")
