...
print(averageHRD)
print("The new average differs from the previous average.")
print("This is because normal integer division returns a number rounded down to the nearest whole number ")
print("On the other hand, dividing decimals of the Double type returns a number with decimal values.")
